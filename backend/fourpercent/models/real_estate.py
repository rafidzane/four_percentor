...
class RealEstateInput(BaseModel):
    ...
    total_property_value: float = Field(default=0.0, ge=0, description="Total estimated property value")
    ...
    # Note: total_property_value defaults to 0.0 to handle cases where real_estate section is missing or incomplete
