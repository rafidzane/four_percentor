...
class SpendingStrategyInput(BaseModel):
    ...
    period_1_withdrawal_amount: Optional[float] = Field(None, ge=0, description="Period 1 fixed withdrawal amount")
    period_1_withdrawal_type: Optional[Literal["percentage", "amount"]] = Field(None, description="Period 1 withdrawal type")
    ...
    period_2_withdrawal_amount: Optional[float] = Field(None, ge=0, description="Period 2 fixed withdrawal amount")
    period_2_withdrawal_type: Optional[Literal["percentage", "amount"]] = Field(None, description="Period 2 withdrawal type")
