              ...
              <div className="flex gap-1">
                <button
                  ...
                  className={`flex-1 py-1 px-2 text-xs rounded-md ${
                    watch("retirement_spending.period_1_withdrawal_type") === "percentage"
                ...
                <button
                  ...
                  className={`flex-1 py-1 px-2 text-xs rounded-md ${
                    watch("retirement_spending.period_1_withdrawal_type") === "amount"
                      ? "bg-primary text-primary-foreground"
                      : "bg-secondary text-secondary-foreground"
                  }`}
                >
              ...
              <div className="flex-1 min-w-[80px]">
                ...
                <div className="flex gap-1">
                  <button
                    ...
                    className={`flex-1 py-1 px-2 text-xs rounded-md ${
                      watch("retirement_spending.period_2_withdrawal_type") === "percentage"
                        ? "bg-primary text-primary-foreground"
                        : "bg-secondary text-secondary-foreground"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 py-1 px-2 text-xs rounded-md ${
                      watch("retirement_spending.period_2_withdrawal_type") === "amount"
                        ? "bg-primary text-primary-foreground"
                        : "bg-secondary text-secondary-foreground"
                    }`}
                  >
