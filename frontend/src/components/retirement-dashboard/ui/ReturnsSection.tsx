...
export const ReturnsSection: FC<ReturnsSectionProps> = ({ className }) => {
  ...
  return (
    <div className={`space-y-6 ${className}`}> 
      <FormItem>
        <FormLabel htmlFor="portfolio_allocation.simulation_mode">
      ...
      {currentMode === "manual" && (
        <>
          ...
          {/* Fixed Income Return */}
          <FormItem>
            <FormLabel htmlFor="portfolio_allocation.fixed_income_return_pct">
              Fixed income return %
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="ghost" size="sm" className="h-4 w-4 p-0 ml-1">
          ...
          {/* Inflation Rate */}
          <FormItem>
            <FormLabel htmlFor="portfolio_allocation.inflation_rate_pct">
              Inflation rate %
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="ghost" size="sm" className="h-4 w-4 p-0 ml-1">
      ...
      {currentMode === "single_year" && (
        <>
          ...
          <FormItem>
            <FormLabel htmlFor="portfolio_allocation.historical_year">
              Historical year
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="ghost" size="sm" className="h-4 w-4 p-0 ml-1">
